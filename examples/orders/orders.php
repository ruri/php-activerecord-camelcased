...
$pokemon = $tito->createOrders(array('item_name' => 'Live Pokemon', 'price' => 6999.99));
$coal    = $tito->createOrders(array('item_name' => 'Lump of Coal', 'price' => 100.00));
...
$pokemon->createPayments(array('amount' => 4999.50, 'person_id' => $tito->id));
$pokemon->createPayments(array('amount' => 2.50, 'person_id' => $jax->id));
